...
const AlgorithmsEvents = require('../layout/events/algorithms/events');
const PipelinesEvents = require('../layout/events/algorithms/events');
...
class Client {
    constructor(options) {
        ...
        this.events = {
            algorithms: new AlgorithmsEvents(data),
            pipelines: new PipelinesEvents(data)
        };
        this.executions = {
