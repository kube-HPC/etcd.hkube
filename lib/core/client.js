...
const AlgorithmQueues = require('../layout/algorithm-queues/AlgorithmQueues');
...
const { AlgorithmQueue, ResourceRequirements, TemplatesStore, AlgorithmDebug, AlgorithmBuilds, AlgorithmExecutions, AlgorithmGraceful, AlgorithmVersions } = require('../layout/algorithms');
...
class Client {
    constructor(options) {
        ...
        this.algorithms = {
            ...
            graceful: new AlgorithmGraceful(data),
        ...
        this.algorithmQueues = new AlgorithmQueues(data);
        ...
        this.watcher = this._client.watcher;
    }

    isFatal(err) {
        return (err instanceof GRPCGenericError || err instanceof EtcdError);
    }
}
