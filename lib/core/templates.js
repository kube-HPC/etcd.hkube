const TEMPLATES = {
    ALGORITHMS: {
        ...
        GRACEFUL: '/algorithms/graceful/{name}',
        QUEUE: '/algorithms/queue/{name}',
        REQUIREMENTS: '/algorithms/requirements/{name}',
        STORE: '/algorithms/store/{name}',
        VERSIONS: '/algorithms/versions/{name}/{version}'
    },
    ALGORITHM_QUEUES: '/algorithmQueues/{queueId}',
    ...
    STREAMING: {
        STATISTICS: '/streaming/statistics/{jobId}/{nodeName}'
    }
};
