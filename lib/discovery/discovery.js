...
class discovery extends EventEmitter {
    ...
    async register(options) {
        ...
        if (result.valid) {
            ...
            this._registerPath = path.join('/', PREFIX.DISCOVERY, this._serviceName, internalInstanceId);
            return this._client.register(ttl, this._registerPath, data);
        }
    ...
    async updateRegisteredData(data) {
        return this._client.updateRegisteredData(this._registerPath, data);
    }
