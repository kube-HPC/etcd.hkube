...
class JobResults extends EventEmitter {
    ...
    async getResultsLog(options) {
        return this._get({ suffix: 'resultLog', jobId: options.jobId });
    }

    async setResultsLog(options) {
        return this._set({ suffix: 'resultLog', data: options.data, jobId: options.jobId });
    }

    async getStatusLog(options) {
        return this._get({ suffix: 'statusLog', jobId: options.jobId });
    }

    async setStatusLog(options) {
        return this._set({ suffix: 'statusLog', data: options.data, jobId: options.jobId });
    }
